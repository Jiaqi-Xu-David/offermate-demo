...
export function shouldUseOcrTextExtraction(text) {
  ...
  const hasConciseStructuredHeader =
    ...
    lineCount >= 3 &&
    compact.length >= 32 &&
    /(姓名|邮箱|电子邮箱|电话|手机号|联系电话|联系方式|微信|\bName\b|\bAddress\b|\bCurrent City\b|\bCurrent Location\b|\bPreferred City\b|\bPresent Location\b|\bDate of Birth\b|\bE-?mail(?: Address)?\b|\bPhone(?: Number)?\b|\bMobile\b|\bCell\b|\bTel\b|\bTelephone\b|\bWeChat\b|\bContact(?: Information| Details)?\b|\bContact\b|\bLinkedIn\b|\bPortfolio\b|\bWebsite\b|\bPersonal (?:Information|Details)\b|\bProfile Details\b|\bProfile Summary\b)/i.test(normalized) &&
