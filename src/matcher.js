...
const KEYWORD_ALIASES = {
  ...
  Slack: ['slack', 'S lack', 's lack', 'Lark', 'lark', '飞书'],
  ...
  PR: ['PR', 'Premiere', 'premiere', 'Premiere Pro', 'premiere pro', 'pr'],
  PS: ['PS', 'Photoshop', 'photoshop'],
  AE: ['AE', 'After Effects', 'AfterEffects', 'after effects', 'aftereffects'],
  Illustrator: ['Illustrator', 'illustrator', 'Adobe Illustrator', 'adobe illustrator'],
  InDesign: ['InDesign', 'indesign', 'Adobe InDesign', 'adobe indesign'],
  Lightroom: ['Lightroom', 'lightroom', 'Adobe Lightroom', 'adobe lightroom'],
